...
//        MATERIAL_FLAGS.put(Material.HARD_CLAY, 0);
        ...
        for (Material material : Material.values()) {
            ...
            if (!MATERIAL_FLAGS.containsKey(material)) {
                logger.fine("Chybí definování materiálu pro " + (material.isBlock() ? "blok " : "item ") + material.name());
            }
        }
...
//        DAMAGE_EFFECTS.add(PotionEffectType.HERO_OF_THE_VILLAGE);
    ...
    public static boolean isCrop(Material type) {
        ...
        return switch (type) {
            case PUMPKIN, MELON, CACTUS, SUGAR_CANE, BAMBOO, BAMBOO_SAPLING, SWEET_BERRY_BUSH, NETHER_WART, CAVE_VINES, CAVE_VINES_PLANT ->
                    true;
            default -> false;
        };
    }
