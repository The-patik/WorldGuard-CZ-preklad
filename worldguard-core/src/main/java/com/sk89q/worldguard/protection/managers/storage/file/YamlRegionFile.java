...
public class YamlRegionFile implements RegionDatabase {
    ...
    private static final String FILE_HEADER = "#\r\n" +
            "# Soubor s regiony WorldGuardu\r\n" +
            "#\r\n" +
            "# VAROVÁNÍ: TENTO SOUBOR SE GENERUJE AUTOMATICKY. Pokud tento soubor upravíte ručně,\r\n" +
            "# uvědomte si, že JEDINÝ CHYBNĚ ZADANÝ ZNAK MŮŽE SOUBOR POŠKOZIT. Pokud WorldGuard\r\n" +
            "# není schopen analyzovat soubor, vaše oblasti SE NEBUDOU NAČÍTAT a obsah tohoto\r\n" +
            "# souboru se resetuje. Použijte prosím validátor YAML, jako je\r\n" +
            "# http://yaml-online-parser.appspot.com (pro menší soubory).\r\n" +
            "#\r\n" +
            "# NEZAPOMEŇTE SI UDRŽOVAT PRAVIDELNÉ ZÁLOHY.\r\n" +
            "#";
    ...
    public Set<ProtectedRegion> loadAll(FlagRegistry flagRegistry) throws StorageException {
        ...
        try {
            ...
            throw new StorageException("Nepodařilo se načíst data regionu '" + file + "'", e);
        }
